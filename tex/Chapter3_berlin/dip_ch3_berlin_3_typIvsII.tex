...
\section{Conclusions}
We have experimentally studied the electronic structure of In$_{1-x}$Ga$_{x}$As$_y$Sb$_{1-y}$/GaP QDs with 5~ML GaAs interlayer which due to high amount of Ga and As have type-I band alignment. For our analysis set of sample (without QDs, with QDs, with QDs and GaSb capping) were grown by MOVPE. 
