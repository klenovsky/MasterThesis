...
\begin{table}
	\centering
	\caption{Summary of the Varshni-like fits. The accuracy of $E_0$ and $\alpha$ are better than $10^{-4}\%$, and better than 5~\% for $\Theta_\mathrm{D}$ and $\sigma$. For comparison bulk values of GaAs and GaP taken from Ref.~\cite{Vurgaftman} are added.}
	\begin{tabularx}{0.9\textwidth}{cCCcc}
		\toprule
		...
		\midrule
		GaAs, $X$& 1981& 4.60& 204& -\\
		GaP, $\Gamma$& 2886& 5.77& 372& -\\
		GaP, $L$& 2720& 5.77& 372& -\\
		\bottomrule
