...
{\color{blue}{To sum up TEM and EDX results, our samples contain In$_{1-x}$Ga$_{x}$As$_y$Sb$_{1-y}$ QDs of shape like truncated pyramid with a higher estimated concentration of Ga ($x=84-93.5~\%$) and As ($y=68-91.5~\%$).}}
%\clearpage
...
see Fig.~\ref{fig:QD_wo_temp}~(b). Interestingly, the bands $M_1^\mathrm{w/o}$ and $M_2^\mathrm{w/o}$ representing phonon and no-phonon assisted $X_{xy}$ to heavy hole transition share temperature evolution, where $\alpha$ of 2.1~$10^{-4}~\mathrm{eVK^{-1}}$ is half to the value for unstrained GaAs~\cite{ioffe, Vurgaftman}. This entropy decrease characterized by $\alpha$ can be understand as effect of {\color{blue}{PS KONEC}}


 In Fig.~\ref{fig:QD_wo_temp}~(c) intensity quenching through the temperature range evaluated by the Boltzmann model~(\ref{eq:Arhenius}) is shown.
%
\begin{figure}
	\centering
...
\begin{table}
	\centering
	\caption{Summary of the Varshni-like fits. The accuracy of $E_0$ and $\alpha$ are better than $10^{-4}\%$, and better than 5~\% for $\Theta_\mathrm{D}$ and $\sigma$. For comparison bulk values of GaAs and GaP taken from Ref.~\cite{Vurgaftman} are added. The avarage phonon energies $\epsilon_\mathrm{av}=k_\mathrm{B}\Theta_\mathrm{D}$.}
	\begin{tabularx}{0.9\textwidth}{ccccccc}
		\toprule
		
		%transition & $E_0$ [meV]& $\alpha$ [$10^{-4}~\mathrm{eVK^{-1}}$]& $\Theta_\mathrm{D}$ [K]& $\sigma$ [meV]\\ 	
		transition & $E_0$ [meV]& $\alpha$ [$10^{-4}~\mathrm{eVK^{-1}}$]& $\Theta_\mathrm{D}$ [K]& $\sigma$ [meV]& $\alpha \Theta_\mathrm{D}/2$ [meV]& $\epsilon_\mathrm{c}$ [meV]\\ 	
		\midrule
		\midrule
		$M_0^\mathrm{w/o}$& $1845$ & $7.99$& $450$&$9.1$& 180&38.8\\
		$M_1^\mathrm{w/o}$& $1838$ & $2.14$& $67$&$2.4$&7.2&5.8\\
		$M_2^\mathrm{w/o}$ & $1865$ & $2.10$& $78$& $1.7$&8.2&6.7\\ 
		...
		\midrule
		$M_0^\mathrm{w}$& $1789$ & $10.00$& $270$& $8.1$&135&23.3\\
		$M_1^\mathrm{w}$& $1789$ & $23.37$& $150.1$&$3.6$&175.4&13.0\\
		$M_2^\mathrm{w}$ & $1815$& $5.49$& $74.5$& $2.8$&20.5&6.4\\ 
		...
		$M_0^\mathrm{c}$& $1756$ & $5.00$& $420$& $7.9$&105&36.2\\
		$M_1^\mathrm{c}$& $1766$ & $4.03$& $144.5$& $3.4$&29.1&12.5\\
		$M_2^\mathrm{c}$ & $1785$ & $4.90$& $243.2$& $1.7\cdot 10^{-5}\pm0.06$&59.6&21.0\\%$3.3\cdot 10^{-7}$\\
		\midrule
		GaAs, $X$& 1981& 4.60& 204& -&46.9&17.6\\
		GaP, $\Gamma$& 2886& 5.77& 372& -&106.0&32.1\\
