...
\end{figure}
%
Emission from capped QD sample were reproduced by calculations performed for In$_{0.15}$Ga$_{0.85}$As$_{0.85}$Sb$_{0.15}$ QD with well match for electrons originating from GaAs $X_{xy}$ (1.725~eV), and QD $\Gamma$ (1.783~eV) and $L$ (1.757~eV) transitions. Radiative times of QD transitions are 29~ns for $\Gamma$ and 231~ns for $L$ electrons.
