...
Dále byla studována excitonová struktura InAs QDs s GaAsSb krycí vrstvou. Tento systém, který představuje uvěznění typu-I i typu-II s charakteristickým modrým posuvem se zvyšujícím se čerpáním, byl zkoumán intenzitně a polarizačně rozlišenou PL. Porovnáním výsledků s vícečásticovými výpočty metodou konfigurační interakce identifikujeme ve spektru vícečásticové přechody neutrálního excitonu, biexcitonu a negativního trionu.  
